...
public class Derived extends Based{
	...
	//상위 클래스에 print()가 있는데 하위 클래스에서 다시 만드는 것을 Method Overriding
	//이라고 합니다.
	@Override //이 메소드가 오버라이딩 된 메소드라는 것을 알아 볼 수 있습니다.
	public void print() {
		System.out.println("하위 클래스의 print");
	}
	
	public void method() {
		print(); // 앞에 아무것도 붙이지 않았기 때문에 자신의 클래스에서부터 찾아 갑니다.
		//자신의 클래스에 만든 print()
		System.out.println("===================");
	...
	//메소드
	public void disp() {
		//num = 10; //num은 private 맴버라서 보이지 않는다고 에러 메시지
